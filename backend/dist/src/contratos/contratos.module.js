...
const contratos_controller_js_1 = require("./contratos.controller.js");
...
exports.ContratosModule = ContratosModule = __decorate([
    (0, common_1.Module)({
        providers: [contratos_service_js_1.ContratosService],
        controllers: [contratos_controller_js_1.ContratosController],
    })
], ContratosModule);
