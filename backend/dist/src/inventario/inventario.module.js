...
const inventario_controller_js_1 = require("./inventario.controller.js");
...
exports.InventarioModule = InventarioModule = __decorate([
    (0, common_1.Module)({
        providers: [inventario_service_js_1.InventarioService],
        controllers: [inventario_controller_js_1.InventarioController],
        exports: [inventario_service_js_1.InventarioService],
    })
], InventarioModule);
