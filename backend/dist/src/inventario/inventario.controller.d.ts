...
export declare class InventarioController {
    ...
    constructor(svc: InventarioService);
    ...
    findAllConjuntos(sucursalId?: string): import(".prisma/client").Prisma.PrismaPromise<({
        sucursal: {
            id: number;
            nombre: string;
            createdAt: Date;
    ...
    desensamblar(id: number): Promise<{
        message: string;
    }>;
    darDeBaja(body: {
        ids: number[];
    ...
    findAllComponentes(sucursalId?: string): import(".prisma/client").Prisma.PrismaPromise<({
        sucursal: {
            id: number;
            nombre: string;
            createdAt: Date;
    ...
    updateEstado(id: number, body: {
        estado: EstadoInstanciaComponente;
        notas?: string;
    }): import(".prisma/client").Prisma.Prisma__InstanciaComponenteClient<{
        id: number;
        createdAt: Date;
