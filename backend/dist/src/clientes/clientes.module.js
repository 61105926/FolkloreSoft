...
const clientes_controller_js_1 = require("./clientes.controller.js");
...
exports.ClientesModule = ClientesModule = __decorate([
    (0, common_1.Module)({
        providers: [clientes_service_js_1.ClientesService],
        controllers: [clientes_controller_js_1.ClientesController],
        exports: [clientes_service_js_1.ClientesService],
    })
], ClientesModule);
